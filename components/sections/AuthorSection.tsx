      ...
      <div className="max-w-5xl mx-auto px-4 py-14 md:py-28">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-20 items-center">
          ...
          >
            {/* Photo placeholder */}
            <div
              className="relative w-full max-w-[280px] md:max-w-xs aspect-square border border-[#CC0000]/30 overflow-hidden mx-auto md:mx-0"
          ...
          >
            ...
            {/* Red accent line */}
            <div className="w-12 h-[2px] bg-[#CC0000] mb-6 md:mb-8" />
